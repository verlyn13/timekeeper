...
class AgentTemporal:
    ...
    - See `Temporal Universe </docs/theory/temporal_universe.md>`_ for complete theory.
    - See `Hierarchical Partition </docs/theory/hierarchical_partition.md>`_ for details on partitions.
    - See `Timepoint Operations </docs/theory/timepoint_operations.md>`_ for operation definitions.
    ...
    def __init__(self, unit_config=None):
        ...
        - See `Temporal Universe </docs/theory/temporal_universe.md#definitions>`_ for
    ...
    def _compute_conversions(self):
        ...
        - See `Hierarchical Partition </docs/theory/hierarchical_partition.md#properties>`_ for
    ...
    def create_timepoint(self, **kwargs):
        ...
        **kwargs : dict
        ...
        - See `Temporal Universe </docs/theory/temporal_universe.md#definition-3-timepoint>`_ for
          details on timepoint representation.
        - See `Hierarchical Partition </docs/theory/hierarchical_partition.md#definition-5-canonical-coordinates>`_ for
    ...
    def normalize(self, timepoint):
        ...
        - See `Temporal Universe </docs/theory/temporal_universe.md#definition-4-canonical-form>`_ for
          details on canonical form.
        - See `Hierarchical Partition </docs/theory/hierarchical_partition.md#property-1-canonical-form-uniqueness>`_ for
    ...
    def to_base_units(self, timepoint):
        ...
        - See `Temporal Universe </docs/theory/temporal_universe.md#definition-5-absolute-representation>`_ for
          details on absolute representation.
        - See `Hierarchical Partition </docs/theory/hierarchical_partition.md#property-2-base-unit-conversion>`_ for
    ...
    def add_time(self, tp, **kwargs):
        ...
        **kwargs : dict
        ...
        - See `Timepoint Operations </docs/theory/timepoint_operations.md#definition-1-timepoint-addition>`_ for
          details on timepoint addition.
        - See `Timepoint Operations </docs/theory/timepoint_operations.md#property-1-associativity-of-addition>`_ for
    ...
    def subtract_time(self, tp, **kwargs):
        ...
        **kwargs : dict
        ...
        - See `Timepoint Operations </docs/theory/timepoint_operations.md#definition-2-timepoint-subtraction>`_ for
          details on timepoint subtraction.
        - See `Timepoint Operations </docs/theory/timepoint_operations.md#property-4-non-negative-time>`_ for
    ...
    def compare_timepoints(self, t1, t2):
        ...
        - See `Timepoint Operations </docs/theory/timepoint_operations.md#definition-3-timepoint-comparison>`_ for
          details on timepoint comparison.
        - See `Timepoint Operations </docs/theory/timepoint_operations.md#property-5-total-ordering>`_ for
    ...
    def time_difference(self, t1, t2):
        ...
        - See `Timepoint Operations </docs/theory/timepoint_operations.md#definition-4-time-difference>`_ for
    ...
    def from_human_time(self, human_dict):
        ...
        - See `Morphisms </docs/theory/morphisms.md#definition-3-human-agent-morphism>`_ for
    ...
    def to_human_time(self, agent_tp):
        ...
        - See `Morphisms </docs/theory/morphisms.md#definition-2-agent-human-morphism>`_ for
